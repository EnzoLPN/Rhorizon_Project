...
Ce module gère le DNS public via Route 53, le provisionnement des certificats SSL (ACM) et la configuration du WAF pour protéger l exposition de l application.

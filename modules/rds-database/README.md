...
Ce module provisionne une instance RDS PostgreSQL isolée avec sécurité renforcée (Subnet Groups, Authentification IAM).
...
| <a name="input_create_external_ingress_rule"></a> [create\_external\_ingress\_rule](#input\_create\_external\_ingress\_rule) | Indique s'il faut créer la règle d'ingress pour le Security Group externe | `bool` | `false` | no |

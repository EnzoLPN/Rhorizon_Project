...
Ce module installe la stack complète d observabilité (Prometheus, Grafana, Fluent Bit) sur le cluster EKS pour le monitoring et la centralisation des logs.
...
| <a name="input_create_grafana_dns_record"></a> [create\_grafana\_dns\_record](#input\_create\_grafana\_dns\_record) | Indique s'il faut créer l'enregistrement DNS Route 53 pour Grafana | `bool` | `false` | no |
